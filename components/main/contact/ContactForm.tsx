...
const ContactForm = () => {
  ...
  return (
    <article className="w-full h-auto mx-auto pt-16 pb-20 md:pt-10 md:pb-[134px]">
        ...
        <div className="">
          ...
          <section className="text-sm md:text-lg mt-10 md:mt-10 mx-auto max-w-[1000px]">
            {responseMessage && (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-center mx-auto ![line-height:170%] text-xs md:text-sm mt-6 md:mt-16 tracking-[0.05em] whitespace-pre-line">
                ...
                送信された個人情報を保管・処理することに同意したものとみなされます。<br/>
